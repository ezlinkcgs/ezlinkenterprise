...
{
	TMSTxnRelMemoryId = CreateMemoryId( dptr, "TMSTXNRELMEMORY" );

	if( TMSTxnRelMemoryId < 0 )
	{
		dptr->trace( "Error in Creating TMSTXNRELMEMORY..." );
		return -1;
	}
...
{
	TMSTerminalProfileMemoryId = CreateMemoryId( dptr, "TMSTERMINALPROFILE" );

	if( TMSTerminalProfileMemoryId < 0 )
	{
		dptr->trace( "Error in Creating TMS Controller Memory[%s]", "TMSTERMINALPROFILE" );
		return -1;
	}
...
{
	TMSChannelPropertyMemoryId = CreateMemoryId( dptr, "TMSCHANNELPROPERTYMEMORY" );

	if( TMSChannelPropertyMemoryId < 0 )
	{
		dptr->trace( "Error in Creating TMSCHANNELPROPERTYMEMORY..." );
		return -1;
	}
...
{
	TMSInBoundPropertyMemoryId = CreateMemoryId( dptr, "TMSINBOUNDPROPERTYMEMORY" );

	if( TMSInBoundPropertyMemoryId < 0 )
	{
		dptr->trace( "Error in Creating TMSINBOUNDPROPERTYMEMORY..." );
		return -1;
	}
...
{
	TMSRouteInfoMemoryId = CreateMemoryId( dptr, "TMSROUTEINFOMEMORY" );

	if( TMSRouteInfoMemoryId < 0 )
	{
		dptr->trace( "Error in Creating TMSROUTEINFOMEMORY..." );
		return -1;
	}
...
{
	TMSRouteSelectMemoryId = CreateMemoryId( dptr, "TMSROUTESELECTMEMORY" );

	if( TMSRouteSelectMemoryId < 0 )
	{
		dptr->trace( "Error in Creating TMSROUTESELECTMEMORY..." );
		return -1;
	}
...
{
	TMSMsgTranslateMemoryId = CreateMemoryId( dptr, "TMSMSGTRANSLATEMEMORY" );

	if( TMSMsgTranslateMemoryId < 0 )
	{
		dptr->trace( "Error in Creating TMSMSGTRANSLATEMEMORY..." );
		return -1;
	}
...
{
	TMSTxnRefSelectMemoryId = CreateMemoryId( dptr, "TMSTXNREFSELECTMEMORY" );

	if( TMSTxnRefSelectMemoryId < 0 )
	{
		dptr->trace( "Error in Creating TMSTXNREFSELECTMEMORY..." );
		return -1;
	}
...
{
        TMSFITProfileMemoryId = CreateMemoryId( dptr, "TMSFITPROFILE" );

        if( TMSFITProfileMemoryId < 0 )
        {
                dptr->trace( "Error in Creating TMSFITPROFILE Memory[%s]", "TMSFITPROFILE" );
                return -1;
        }
