...
void EzTMSLogger :: serviceRequest()
{
	...
	while( 1 )
	{
		...
		if( ( tmsloggermsg.LogFlag & 0x2 ) == 0x2 )
		{
			...
			trace( "InstId[%s] PosId[%s] TermId[%s] MerchantId[%s] BatchId[%s] TxnRefNum[%s] MsgType[%d] TxnCode[%d] CHN[%s] TermLoc[%s] TraceNo[%d] AuthNum[%s] RefNum[%s] TranDate[%d] TranTime[%d] LocalDate[%d] LocalTime[%d] RespCode[%d] AuthCode[%d] CurrencyCode[%d] MCC[%d] TxnAmount[%s]", tmsloggermsg.txnmsg.AcquirerInst, tmsloggermsg.MachineId, tmsloggermsg.txnmsg.TerminalId, tmsloggermsg.txnmsg.AcceptorId, tmsloggermsg.txnmsg.BatchId, tmsloggermsg.TMSTxnRefNum, tmsloggermsg.txnmsg.MsgType, tmsloggermsg.txnmsg.TxnCode, tmsloggermsg.txnmsg.m_chn, tmsloggermsg.txnmsg.TerminalLocation, tmsloggermsg.txnmsg.TraceNo, tmsloggermsg.txnmsg.AuthNum, tmsloggermsg.txnmsg.RefNum, tmsloggermsg.txnmsg.TranDate, tmsloggermsg.txnmsg.TranTime, tmsloggermsg.txnmsg.LocalDate, tmsloggermsg.txnmsg.LocalTime, tmsloggermsg.txnmsg.RespCode, tmsloggermsg.txnmsg.AuthCode, tmsloggermsg.txnmsg.AcqCurrencyCode, tmsloggermsg.txnmsg.MerchantType, tmsloggermsg.txnmsg.Amount );
