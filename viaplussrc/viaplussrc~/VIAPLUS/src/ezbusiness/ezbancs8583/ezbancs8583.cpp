#include <ezbusiness/ezbancs8583.h>

EzBancs8583 :: EzBancs8583()
{
}
...
void EzBancs8583 :: InitEzBancs8583( const char *TaskName )
{
...
int EzBancs8583 :: ComposeISOMessage( struct EzTxnMsg *txnmsg, char *OutBuf )
{
...
int EzBancs8583 :: DecomposeISOMessage( char *InBuf, struct EzTxnMsg *txnmsg )
{
	unsigned char BitMap[ 33 ];
...
void EzBancs8583 :: removeLeadingZeros( const char *SrcStr, char *DestStr )
{
	int i = 0;
...
void EzBancs8583 :: ServiceRequest()
{
...
{
	EzBancs8583 ezbancs8583obj;
	ezbancs8583obj.InitEzBancs8583( argv[ 0 ] );
	ezbancs8583obj.ServiceRequest();
	return 1;
}
