...
static unsigned int sqlctx = 19513323;
...
{12,4130,1,0,0,
5,0,0,1,76,0,4,22,0,0,2,1,0,1,0,2,5,0,0,1,5,0,0,
};
...

{
 ...
 sqlstm.stmt = "select RTRIM(NETWORKID) into :b0:b1  from EZSAFDB where RTRI\
M(NETWORKID)=:b2";
 ...
 sqlstm.sqhstv[1] = (         void  *)Input_NetworkId;
